...
public class Signature {
	...
	public static String getSign(Map<String, Object> map,String key) {
		...
		String result = sb.toString();
		result += "key=" + key;
		System.err.println("result1_1:"+result);
		result = MD5.MD5Encode(result).toUpperCase();
		System.err.println("result1_2:"+result);
		return result;
	}
	...
	public static String getSignFromResponseString(String responseString,String key)
		...
		Map<String, Object> map = XMLFactory.getMapFromXML(responseString);
	...
	public static boolean checkIsSignValidFromResponseString(
			String responseString,String key) throws ParserConfigurationException,
